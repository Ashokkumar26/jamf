...
var get_mobile_device_by_name_1 = require("../actions/get-mobile-device-by-name");
var automation_utils_1 = require("@skitter/automation-utils");
var errors_1 = require("../common/errors");
describe("Get Mobile Device by Name", function () {
    it("Get Mobile Device by Name", function () { return __awaiter(void 0, void 0, void 0, function () {
        var input, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, get_mobile_device_by_name_1.execute(input)];
                case 1:
                    res = _a.sent();
    ...
    it("Ivalid URL", function () { return __awaiter(void 0, void 0, void 0, function () {
        var error, input, myerror_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    error = automation_utils_1.makeError(errors_1.errors.DEVICE_NAME_NOT_EXIST.code, errors_1.errors.DEVICE_NAME_NOT_EXIST.message);
                    input = {
                        auth: {
                            username: "ashok",
                            password: "Skitter@123",
    ...
    it("Device Name not Exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    myerror_6 = _a.sent();
                    expect(myerror_6).toStrictEqual(error);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    it("Device Name not Exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    myerror_7 = _a.sent();
                    expect(myerror_7).toStrictEqual(error);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
